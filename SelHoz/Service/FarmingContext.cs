...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<CultivatedArea>(entity =>
        {
            ...
            entity.Property(e => e.SowingDate).HasColumnName("sowing_date");
        });
        ...
        modelBuilder.Entity<Fertilizer>(entity =>
        {
            ...
            entity.Property(e => e.DateManufacture).HasColumnName("date_manufacture");
        ...
        modelBuilder.Entity<OrderingFertilizer>(entity =>
        {
            ...
            entity.Property(e => e.AmountFertilizer).HasColumnName("amount_fertilizer");
            entity.Property(e => e.IdFertilizer).HasColumnName("id_fertilizer");
            entity.Property(e => e.IdProvider).HasColumnName("id_provider");
            entity.Property(e => e.OrderDate)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("order_date");
            entity.Property(e => e.PriceFertilizer).HasColumnName("price_fertilizer");
